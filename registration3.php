...
<div class="steps mt30">
    <div class="container">
        <ul>
            ...
            <li class="step-one active"><a href="#"><span>3</span>Step 3</a></li>
        ...
        <div class="col-md-8 register pdzero reg_Details mt30 step4">
            <div class="regdetails mt10">
                ...
                <?php            
                    ...
                    {
                ?>                       
                <form class="mt20"  name="Registration4" id="defaultForm"  method="post"  action="regins3" onsubmit="return validate_form();" >                                                
                            <div class="row m0">
                            ...
                            ?>                                               
                                ...
                                <a href="registration2?passkey=<?php echo $_GET['passkey']; ?>" ><input type="Button" value="Back" class="button row mt30"> </a>
...
<!--                             <div class="form-group">
                              <div class="col-sm-5">
                               <div class="checkbox">                        
                        <label>
                            <input id="rememberme" name="rememberme" required="true" type="checkbox" value="yes" name="terms"><a href="legal.php" target="_blank"> *I Agree All Terms and Conditions </a>
                        </label>                       
                    </div>
            </div>
       </div>-->
                            <input type="submit" value="Save" id="sub" onsubmit="return validate_form();" class="button row mt30" >
                            <a href="registration2?passkey=<?php echo $_GET['passkey']; ?>" ><input type="Button" value="Back" class="button row mt30" onclick="history.go(-1);"> </a>
                            <!--<input type="reset" value="Reset" class="button row reset mt30">-->
                        </form> 
                <?php                     
                    } 
