        ...
        <div class="who-we-are mt30">
            <div class="container">
                ...
                WHERE a.vendor_id = '" . $id . "' AND a.advertise_id = '" . $adv_id . "' and a.is_delete=0 ORDER BY a.advertise_id DESC LIMIT 1";
                                ...
                                $v_like = $row1['v_likes'];
                                ?>
                                <img src=" <?php echo ROOT_PATH; ?>vendor_admin/images/<?php echo $img;?>"/>
                                <?php
                                $count1 = 1;
                                $cl1 = '';
                        ...
                        <div class="share-details mt15">
                            ...
                            <div class="col-sm-12 col-xs-12 pd0">
                                <a class="col-sm-9 col-xs-8 pd0 mt5" onclick="doSomethings(<?php echo $rowvwndor['vendor_id']; ?>);"   name="post_id">
                                    <label>Like your vendor</label> <span class="heart" id="likes_new" data-lkid="<?php echo $rowvwndor['vendor_id']; ?>"><?php echo $likeed; ?> </span> 
                                </a>
                                <div class="pd0 col-sm-3 col-xs-4"><a href="https://www.lovestruckdeals.com/weddingdeals?cat_id=<?php echo $catID; ?>" class="more-deals pull-right">More Deals</a></div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-lg-12 pd0">
                                ...
                                <div class="db">
                                    <div class="chat pull-right">
                                        <a id="getaID" class="getaID" href="<?php echo ROOT_PATH; ?><?php echo $row['vendor_id']; ?>" data-toggle="modal" role="button" data-target="#myModalChat">Message</a>
                                    </div>
                            ...
                            <div class="packages">
                                <div class="bor">
                                    ...
                                    <div class="details">
                                        ...
                                        <?php
                                        $aid = $addrow['vendor_id'];
                                        ?> 
                                        <form  name="add_form"  >
                                            <div class="likes">
                                                <input type="hidden" name="advertise_id" value='<?php echo $addrow['advertise_id']; ?> '/>
                                                <ul>
                                                    <li><a onclick="doSomethingDeal(<?php echo $addrow['advertise_id']; ?>);"  name="post_id">
                                                   <span class="heart" id="likes_new1" data-lkid2="<?php echo $addrow['advertise_id']; ?>" >&nbsp;<?php echo $like2; ?> </span>  </a></li>
...
<script>
        ...
        $(document).on("click", "#likes_new", function (e) {
            e.preventDefault();
            var add_id = $(this).data("lkid").valueOf();
            var sessionid = '<?php echo $sessionid; ?>';
            $.ajax({
