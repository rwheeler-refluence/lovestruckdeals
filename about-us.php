...
?>
<title>Get Information about LoveStruckdeals in details | About us</title>
<meta name="description" content="Want to make Your Wedding Special? then you are at right place. LoveStruckdeals.com makes available free chat button to find the wedding deals, wedding packages of your choice. Know about us in details here."/>
<!---- We Are ---> 
<div class="about">
        ...
        <div class="row">
            <div class="col-sm-6 col-xs-12 about-desc pd0">
                ...
                <div class="col-sm-8 wdp col-xs-8 pd0">  
                    <p><span class="uppercase"> FIND BEST DEALS</span>
                        Who says that you can't plan beautiful wedding on a budget? Browse through deals posted by the industry's top wedding vendors and save thousands on your wedding!  </p>
                    <a href="weddingdeals" class="read-more mrgn">Find deals</a>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-xs-12 about-desc pd0">
                ...
                <div class="col-sm-8 wdp col-xs-8 pd0">  
                    ...
                    <a href="local-vendors" class="read-more mt30">Find vendors</a>
                </div>
            </div>
        </div>
            ...
            <div class="col-sm-6 col-xs-12 about-desc pd0 mt30">
                ...
                <div class="col-sm-8 wdp col-xs-8 pd0"> 
                    <p><span class="uppercase">VENDOR SIGN-UP</span>
                        Ready to chat with brides and offer them your wedding deal? Create a free profile, upload your images and a video and start booking more weddings today!</p>
                    <?php  if (!isset($_SESSION['fname'])) 
               {
                   ?><a href="registration" class="read-more mt30">Sign Up</a> <?php } ?>
                </div>
