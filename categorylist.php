...
<script type="text/javascript">
    function filtercategory(add_id, basic1, stateID, cityID)
    {
        ...
        $.ajax({
            type: "POST",
            url: 'searchindexcategorylocationlist',
...
<div class="wedding_deals">
    <div class="col-lg-12">
        <div class="container">
                ...
                <div class="col-sm-2 col-xs-4 pull-right pd0">
                    ...
                    <div class="col-sm-4 col-xs-5 pd0">
                        <div class="venue-right list">
                            <a class="pageval" href="categorylist?cat_id=<?php echo $catid; ?>">
                                <p>List</p>
                            </a>
                        </div>
                    </div>
            ...
            <form  name='data' id="data" method="POST" enctype="multipart/form-data" action="searchindexcategorylocation">
                <div class="col-sm-10 mt30 mb30 col-sm-push-1 col-xs-12 wd100sm">
                    ...
                    <div class="col-sm-4 col-xs-12 pdzero loc_disappear" id="ctaid">
                            ...
                            <div class="details">
                                <div class="border">
                                    <div class="deal pd0">
                                        <h5 class="mt0">
                                            <strong>
                                                <a href="vendor-profile?adv_id=<?php echo $addrow['advertise_id']; ?>"><?php company_echo($addrow['dealtitle'], 25); ?>
                                                </a>
                                            </strong>
                                        </h5>
                                    ...
                                    <div class="deal-right deal-static pd0 pull-right">
                                        <span>
                                            <a id="getaID" class="getaID" href="<?php echo $id1 = $addrow['advertise_id']; ?>" data-toggle="modal" role="button" data-target="#myModal1">Message
                                            </a>
                                        </span>
                                    </div>
                                </div>
            ...
            ?>
                                        ...
                                        <div class="details times-Square-left">
                                            <div class="border">
                                                ...
                                                <div class="now pd0 deal-right deal-static pull-right">
                                                    <span>
                                                        <span class="tp0">
                                                            <a id="getaID" class="getaID" href="<?php echo $id1 = $addrow1['advertise_id']; ?>" data-toggle="modal" role="button" data-target="#myModal1">Message</a>
                                                        </span>
                                                    </span>
                                                </div>
                                            </div>
                            ...
                            <div class="col-sm-8 times-Square">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 pd0 col-xs-4">
                                       ...
                                       <a href="<?php echo "https://".$addrow1['c_website']; ?>" target="blank" class="color website site">Website</a>
                                    </div>
                                    <br>
                ...
                <div class="bs-example">
                    <ul class="pagination  mt40">
                        ...
                        ?>
                        <li><a class='paging' href="categorylist?stateID=<?php echo $state; ?>&cityName=<?php echo $city; ?>&cat_id=<?php echo $catid; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                        <?php
                            }
                        ?>
                        <?php
