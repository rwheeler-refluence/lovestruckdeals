                ...
                <div class="col-sm-2 col-xs-4 pull-right pd0">
                    ...
                    <div class="col-sm-4 col-xs-5 pd0">
                        <div class="venue-right photo">
                            <a href="wedding_deals.php"><p>Photo</p></a>
                        </div>
                    </div>
                    <div class="col-sm-4 col-xs-5 pd0">
                        <div class="venue-right list">
                            <a class="pageval" href="category_list.php?cat_id=<?php echo $catid; ?>">
                                <p>List</p>
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="packages packages2">
                        <div class="bor">
                            <div class="col rspsv_img">
                                ...
                                <a href="vendor-profile.php?adv_id=<?php echo $addrow['advertise_id']; ?>">
                                    <img src="vendor_admin/images/<?php echo $addrow['advertise_img']; ?>" width="269" height="253">
                                </a>
            ...
            ?>
                                    ...
                                    <div class="bor">
                                        <div class="col rspsv_img">
                                            ...
                                            <a href="vendor-profile.php?adv_id=<?php echo $addrow1['advertise_id']; ?>">
                                                <img src="vendor_admin/images/<?php echo $addrow1['advertise_img'] ?>" />
                                            </a>
                                        </div>
                ...
                <div class="bs-example">
                    <ul class="pagination  mt40">
                        ...
                        ?>
                            <li><a class='paging' href="category_list.php?stateID=<?php echo $state; ?>&cityName=<?php echo $city; ?>&cat_id=<?php echo $catid; ?>&page=<?php echo "1" ?>"><?php echo "<<" ?></a></li>
                        <?php
                            for ($i = 1; $i <= $total_pages - 1; $i++) 
                            {
                                
                        ?>
                            <li><a class='paging' href="category_list.php?stateID=<?php echo $state; ?>&cityName=<?php echo $city; ?>&cat_id=<?php echo $catid; ?>&page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
                        <?php
                            }
                        ?>
                        <?php
