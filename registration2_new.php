    ...
    <div class="container">
        ...
        <div class="col-md-8 register reg_Details mt30">
            <div class="regdetails mt10">                                   
                ...
                <form class="mt20"  name="regisform2" onsubmit="return searchvaidation()" id="informationForm" method="post"  action="regins2_new.php" >
...
<!--                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div id="basic" class="selectpicker show-tick col-lg-3 all-loc">
                            <div class="loc1"></div>

                            <input type="text" id="txtAddress" name="txtAddress" placeholder="All Location" size="20">
                             <div id="address_error" style="display:none"class="error_msg" ><font color="red"> Please Search Correct State And City</font></div>
                            <div id="address_error1" style="display:none"class="error_msg" ><font color="red"> Please Search Valid State And City</font></div>
                        </div>
