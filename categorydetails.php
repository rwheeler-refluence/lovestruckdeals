...
//
//    $add2 = "SELECT * FROM advertisement WHERE advertise_id ='$id' ";
...
<!--                                            <span class="top-heading">
                                ...
                                <div class="nano-content">
                                    <ul class="gw-nav gw-nav-list">
                                        ...
                                        <li class="init-arrow-down"> 
                                            ...
                                            <ul class="gw-submenu">
                                                <?php
                                                    $sql2 = "SELECT filterid,type FROM filter WHERE isdel='1' and categoryId='".$id."'";                                                    
                ...
                <!-- Rahul Sortlight -->
                 <div class="col-lg-9 pd0" id="grid"> 
                     <div class="featured">
                    <?php
                    $add = "SELECT a.categoryId, a.adv_type,a.likes,a.advDisplayDate,a.advExpiryDate,a.advertise_id, a.description,a.dealtitle, a.advertise_img, a.price,v.fname,a.vendor_name, c.categoryName,cit.cityName
...
<!--                                        <div class="tag"><?php// echo $diff->format("%a days left"); ?></div>-->
       ...
       <?php
                    ...
                    $add1 = "SELECT a.categoryId, a.adv_type,a.likes,a.advDisplayDate,a.advExpiryDate,a.advertise_id,v.fname, a.description,a.dealtitle, a.advertise_img,cit.cityName,
                            a.vendor_name, c.categoryName
                            FROM advertisement a, category c,vendor_details v,city cit
                            WHERE a.categoryId = c.categoryId
                            AND a.vendor_id = v.vendor_id
                            AND a.cityId=cit.cityId
...
<!--                                        <div class="tag"><?php// echo $diff->format("%a days left"); ?></div>-->
                                        <a href="vendor-profile.php?adv_id=<?php echo $advertise_id1; ?>"><img src="images/<?php echo $addrow1['advertise_img']; ?>"  width="269" height="253"/> </a>                                                                                   
                     ...
                     <div class="bs-example">
                         <ul class="pagination  mt40">
                             ...
                             echo "<li><a href='categorydetails.php?page=1&cat_id=".$id."'>&laquo;</a></li>";

                             for ($i = 1; $i <= $total_pages; $i++) {
                                 echo"<li><a href ='categorydetails.php?page=".$i."&cat_id=".$id."'>".$i."</a></li>";
                             };
                             echo "<li><a href ='categorydetails.php?page=$total_pages&cat_id=".$id."'>&raquo;</a></li>";
                             ?>  
                         </ul>
                     </div>
